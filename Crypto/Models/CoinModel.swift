...
/*
 ...
 struct CoinModel: Identifiable, Codable {
     ...
     //passing the value for currentHoldings and returning CoinModel instance
     ...
     //if we have currentHoldings (bitcoin = 1) and price ($30000) then currentHoldingsValue returns (1 * 30000)
